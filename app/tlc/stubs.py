...
FAKE_TYPES = [TLCViolationType.FAILURE_TO_INSPECT_VEHICLE , TLCViolationType.DIRECTIVE , TLCViolationType.ENFORCEMENT_ACTION , TLCViolationType.FAILURE_TO_COMPLY_WITH_NOTICE , TLCViolationType.REINSPECTION_FEE]
