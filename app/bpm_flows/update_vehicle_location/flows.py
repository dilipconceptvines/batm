...
VEHICLE_LOCATION_RULES = {
    VehicleStatus.AVAILABLE_FOR_HACK_UP.value: {
        ...
        "allowed_locations": [
            ...
            VehicleLocation.MAACO.value,
            VehicleLocation.METRO_SHOP.value,
            VehicleLocation.TAXICAB_PRODUCTS.value,
            VehicleLocation.HUDSON_TOYOTA.value,
            VehicleLocation.HILLSIDE_TOYOTA.value,
