...
def process_edit_vehicle_inspection_expenses_and_compliance(db, case_no, step_data):
    ...
    try:
        ...
        if expense.sub_type in allowed_inspection_types:
            ...
            insurance_exists = vehicle_service.get_vehicle_insurance(
                db=db, vehicle_id=expense.vehicle_id, insurance_type=expense.sub_type , insurance_start_date=expense.issue_date 
            )

            insurance_data = {
                "id": insurance_exists.id if insurance_exists else None,
                "vehicle_id": expense.vehicle_id,
