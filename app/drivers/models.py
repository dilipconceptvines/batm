...
from app.notes.models import DriverNote
...
class Driver(Base, AuditMixin):
    ...
    def to_dict(self):
        ...
        return {
            ...
            "ssn": self.ssn,
            "dob": self.dob,
            "phone_number_1": format_us_phone_number(self.phone_number_1),
            "phone_number_2": format_us_phone_number(self.phone_number_2),
